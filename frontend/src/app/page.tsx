  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 font-sans antialiased ${
      ...
      <nav 
        ...
        className={`w-full px-4 lg:px-8 py-3.5 flex items-start justify-between gap-3 sticky top-0 z-50 border-b transition-colors ${
          isDark 
        ...
        <div className="flex items-start space-x-3 min-w-0">
          ...
          <div className="flex flex-col gap-0.5 min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className={`text-[10px] sm:text-xs font-bold px-2 py-0.5 rounded-md border shrink-0 ${
                isDark 
            ...
            <p className={`text-[11px] sm:text-xs font-medium leading-tight ${isDark ? 'text-zinc-400' : 'text-slate-500'}`}>
              Distributed Predictive Pacing &amp; Safety Controller Engine
            </p>
          </div>
        </div>

        {/* Right Header Controls - De-emphasized secondary buttons */}
      ...
      <main data-testid="main-content" className="flex-1 max-w-7xl w-full mx-auto p-3 sm:p-4 md:p-6 lg:p-8 space-y-6">
        ...
        <section 
          ...
          className={`rounded-2xl p-4 sm:p-5 md:p-6 border transition-all mt-2 ${
            isDark 
        ...
        >
          <div className="space-y-1">
            <h2 className={`text-base sm:text-lg font-extrabold flex items-center gap-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>
              <Sliders className="w-5 h-5 text-emerald-600 shrink-0" /> Operational Scenarios &amp; Simulation Control
            </h2>
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2.5 w-full md:w-auto">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2.5 w-full sm:w-auto">
              ...
              <button
                ...
                className="touch-target bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-white px-4 py-2.5 rounded-xl text-xs font-black flex items-center justify-center gap-2 transition-all shadow-md shadow-emerald-600/20 disabled:opacity-50 w-full sm:w-auto"
              >
              ...
              {/* Shock Filter Trigger Button (Danger Warning Standard) */}
              <button
                ...
                className={`touch-target px-3.5 py-2.5 rounded-xl text-xs font-extrabold flex items-center justify-center gap-1.5 border transition-all w-full sm:w-auto ${
                  isDark 
                    ? 'bg-red-950/40 hover:bg-red-900/60 text-red-300 border-red-800/80' 
              ...
              <button
                ...
                className={`touch-target px-4 py-2.5 rounded-xl text-xs font-semibold flex items-center justify-center gap-2 border transition-all w-full sm:w-auto ${
                  isDark 
                    ? 'bg-transparent hover:bg-zinc-800 text-zinc-300 border-zinc-700' 
                    : 'bg-transparent hover:bg-slate-100 text-slate-700 border-slate-300'
                }`}
        ...
        <section aria-label="System Metrics Overview" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className={`p-5 rounded-2xl border transition-all ${
            isDark ? 'bg-zinc-900/90 border-zinc-800 shadow-lg' : 'bg-white border-slate-200 shadow-xs'
            ...
            <div>
              ...
              <p className={`text-2xl font-black mt-1 ${isDark ? 'text-emerald-400' : 'text-emerald-700'}`}>{telemetry?.pacing.suggestionMessage || 'Requesting 12 calls'}</p>
