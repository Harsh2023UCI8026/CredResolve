...
export class SafetyController {
  private static overdialRatioLimit = 1.3; // M_overdial
  private static agentBuffer = 1;         // A_buffer
  private static maxAbandonmentRate = 0.005; // 0.5% (strict compliance limit)
  private static maxProviderErrorRate = 0.05; // 5%
  private static maxProviderLatency = 2500;   // 2500ms
  
  private static lastAgentCount = 0;
  private static lastAgentCheckTime = Date.now();
  private static freezeUntilTime = 0;

  private static auditLogs: SafetyAuditLog[] = [];

  public static getLogs(): SafetyAuditLog[] {
