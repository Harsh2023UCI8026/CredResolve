...
exports.ScenarioSimulationHarness = void 0;
const store_1 = require("../db/store");
const predictiveEngine_1 = require("../engines/predictiveEngine");
const safetyController_1 = require("../engines/safetyController");
class ScenarioSimulationHarness {
    static async initializePool(agentCount, borrowerCount) {
        store_1.dbStore.seedDefaults();
        for (let i = 1; i <= agentCount; i++) {
            ...
            await store_1.dbStore.saveAgent(agent);
        }
    ...
    static async runScenario(scenarioName) {
        ...
        for (let tick = 1; tick <= totalTimeUnits; tick++) {
            ...
            const pacing = predictiveEngine_1.PredictiveEngine.calculateTargetCalls({
            ...
            const safety = safetyController_1.SafetyController.evaluateRequest(pacing.targetCalls, availAgents.length, 0, currentAbandonRate, 0.01, 150);
...
exports.ScenarioSimulationHarness = ScenarioSimulationHarness;
